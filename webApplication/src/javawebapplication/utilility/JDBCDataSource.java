package javawebapplication.utilility;
...
public class JDBCDataSource {
    ...
    public static JDBCDataSource getInstance() {
        if (datasource == null) {
            ResourceBundle rb = ResourceBundle.getBundle("javawebapplication.systemproperties.System");
	...
	public static void main(String[] args) {
		...
		System.out.println("password data: " + pass);
		System.out.println("username data: " + pass);
		...
		try {
			...
			int rs = stmt.executeUpdate("insert into user(username, password) values('musa', 'musa@124')");
			//nnection("jdbc:mysql://localhost:3306/webapp", "root", "root");
